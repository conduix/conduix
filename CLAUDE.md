...
- **pipeline-daemon**: Pipeline execution agent (Go + Gin)
...
cd pipeline-daemon && make run-local
...
pipeline-daemon/         # Depends on: shared, pipeline-core
