...
// Source 타입 정의
// sql_event 는 구명칭 alias — 기존 저장 워크플로우 렌더용으로만 유지
type SourceType = 'rest_api' | 'kafka' | 'cdc' | 'sql' | 'file' | 'sql_incremental' | 'sql_event' | 'kubernetes'
...
const autoRealtimeModeBySourceType: Record<string, RealtimePipelineMode> = {
  ...
  sql_incremental: 'raw', // 증분 폴링이므로 raw 모드
  sql_event: 'raw', // 구명칭 alias
