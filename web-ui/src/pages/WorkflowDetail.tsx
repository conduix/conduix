                          ...
                          <TableRow key={pipeline.id}>
                            ...
                            <TableCell>
                              <Box sx={{ display: 'flex', gap: 0.5 }}>
                                <IconButton
                                  size="small"
                                  onClick={() => navigate(`/projects/${workflow?.project?.alias}/workflows/${effectiveId}/pipelines/${pipeline.id}/source`)}
                                ...
                                <IconButton
                                  size="small"
                                  onClick={() => navigate(`/projects/${workflow?.project?.alias}/workflows/${effectiveId}/pipelines/${pipeline.id}/stages`)}
